...
- "resolve_doc" : Resolve a document reference (Luật X, Nghị định Y, Thông tư Z) to UUID
...
│  You MUST output 2 additional boolean flags in your JSON response:         │
...
│                                                                            │
│  (mentions_specific_doc removed in V2.1 — derived from task_plan[0]=="resolve_doc")│
└────────────────────────────────────────────────────────────────────────────┘
...
"Xin chào"
→ {{"next_agent":"direct","intent":"greeting","task_plan":["greeting"],"needs_memory":false,"is_legal_query":false,"reasoning":"Pure greeting, no topic"}},

"Cảm ơn bạn!"
→ {{"next_agent":"direct","intent":"greeting","task_plan":["greeting"],"needs_memory":false,"is_legal_query":false,"reasoning":"Thank you message"}},

"Tôi là ai trong hệ thống?"
→ {{"next_agent":"direct","intent":"personal","task_plan":["personal"],"needs_memory":true,"is_legal_query":false,"reasoning":"User asking about their own identity"}}

"Tôi đang sử dụng thiết bị nào?"
→ {{"next_agent":"direct","intent":"personal","task_plan":["personal"],"needs_memory":true,"is_legal_query":false,"reasoning":"User asking about their own equipment/device profile"}}

──── SEARCH (general RAG, no specific doc) ────

"An ninh mạng là gì?"
→ {{"next_agent":"rag","intent":"search","task_plan":["search"],"needs_memory":false,"is_legal_query":true,"reasoning":"Definition question, no specific law cited"}}

"Quy định về bảo vệ dữ liệu cá nhân như thế nào?"
→ {{"next_agent":"rag","intent":"search","task_plan":["search"],"needs_memory":false,"is_legal_query":true,"reasoning":"General policy question, no specific document named"}}

"Hành vi nào bị coi là vi phạm an ninh mạng?"
→ {{"next_agent":"rag","intent":"search","task_plan":["search"],"needs_memory":false,"is_legal_query":true,"reasoning":"Topic-based search, no document reference"}}

"Trách nhiệm của cơ quan chủ quản hệ thống thông tin là gì?"
→ {{"next_agent":"rag","intent":"search","task_plan":["search"],"needs_memory":false,"is_legal_query":true,"reasoning":"Legal concept question"}}

──── SEARCH_ABBR (abbreviation meaning) ────

"BMNN là gì?"
→ {{"next_agent":"rag","intent":"search_abbr","task_plan":["search_abbr"],"needs_memory":false,"is_legal_query":true,"reasoning":"User asking about abbreviation meaning"}}

"TTGT viết tắt của từ gì?"
→ {{"next_agent":"rag","intent":"search_abbr","task_plan":["search_abbr"],"needs_memory":false,"is_legal_query":true,"reasoning":"Abbreviation lookup"}}

"ANTT nghĩa là gì?"
→ {{"next_agent":"rag","intent":"search_abbr","task_plan":["search_abbr"],"needs_memory":false,"is_legal_query":true,"reasoning":"Abbreviation definition query"}}

──── LIST_DOCS ────

"Liệt kê các tài liệu có trong hệ thống"
→ {{"next_agent":"rag","intent":"list_docs","task_plan":["list_docs"],"needs_memory":false,"is_legal_query":true,"reasoning":"User wants to browse available documents"}}

"Có những văn bản pháp luật nào?"
→ {{"next_agent":"rag","intent":"list_docs","task_plan":["list_docs"],"needs_memory":false,"is_legal_query":true,"reasoning":"Listing documents"}}

──── KG_QUERY (entity/org relationships) ────

"Bộ Công an có những đơn vị nào trực thuộc?"
→ {{"next_agent":"rag","intent":"kg_query","task_plan":["kg_query"],"needs_memory":false,"is_legal_query":true,"reasoning":"Organizational structure query"}}

"Ai chịu trách nhiệm về an ninh mạng quốc gia?"
→ {{"next_agent":"rag","intent":"kg_query","task_plan":["kg_query"],"needs_memory":false,"is_legal_query":true,"reasoning":"Responsibility/entity relationship"}}

──── SEARCH_DOC_NUM (lookup by doc number) ────

"Tìm văn bản 53/2022/NĐ-CP"
→ {{"next_agent":"rag","intent":"search_doc_num","task_plan":["search_doc_num"],"needs_memory":false,"is_legal_query":true,"reasoning":"Direct lookup by document number"}}

──── RESOLVE_DOC + SEARCH (named document, content question) ────

"Luật An ninh mạng 2018 quy định gì về xử phạt?"
→ {{"next_agent":"rag","intent":"resolve_doc","task_plan":["resolve_doc","search"],"needs_memory":false,"is_legal_query":true,"reasoning":"Named law + content question → find doc UUID first, then search within it"}}

"Thông tư 15 của Bộ Công an quy định gì?"
→ {{"next_agent":"rag","intent":"resolve_doc","task_plan":["resolve_doc","search"],"needs_memory":false,"is_legal_query":true,"reasoning":"Named circular → resolve first, then retrieve content"}}

"Nghị định 13 về bảo vệ dữ liệu cá nhân nói gì về quyền của chủ thể dữ liệu?"
→ {{"next_agent":"rag","intent":"resolve_doc","task_plan":["resolve_doc","search"],"needs_memory":false,"is_legal_query":true,"reasoning":"Named decree + specific topic question"}}

"Văn bản số 83/2026/NĐ-CP quy định gì?"
→ {{"next_agent":"rag","intent":"resolve_doc","task_plan":["resolve_doc","search"],"needs_memory":false,"is_legal_query":true,"reasoning":"Explicit doc number referenced → resolve then search"}}

"Đơn vị tôi có cần tuân thủ Luật An ninh mạng không?"
→ {{"next_agent":"rag","intent":"resolve_doc","task_plan":["resolve_doc","search"],"needs_memory":true,"is_legal_query":true,"reasoning":"Core question is about law compliance → resolve_doc+search. System will auto-resolve 'đơn vị tôi' via memory recall before agent runs."}}

"Cơ quan tôi có phải báo cáo theo Nghị định 13 không?"
→ {{"next_agent":"rag","intent":"resolve_doc","task_plan":["resolve_doc","search"],"needs_memory":true,"is_legal_query":true,"reasoning":"Law compliance question with personal context — route to RAG; memory recall auto-triggered by 'tôi' keyword."}}

"Tôi là ai trong hệ thống?"
→ {{"next_agent":"direct","intent":"personal","task_plan":["personal"],"needs_memory":true,"is_legal_query":false,"reasoning":"Purely asking about own system identity — no law or document involved"}}

"Tôi có những tài liệu nào?"
→ {{"next_agent":"rag","intent":"list_docs","task_plan":["list_docs"],"needs_memory":true,"is_legal_query":true,"reasoning":"Asking about available documents — list_docs; memory recall auto-triggered for personal workspace context"}}

──── RESOLVE_DOC + SEARCH_SECTION (named document + specific article) ────

"Điều 3 Luật An ninh mạng 2018 nói gì?"
→ {{"next_agent":"rag","intent":"resolve_doc","task_plan":["resolve_doc","search_section"],"needs_memory":false,"is_legal_query":true,"reasoning":"Named law + specific article → resolve doc first, then section search"}}

"Điều 5 Nghị định 83/2026/NĐ-CP quy định gì?"
→ {{"next_agent":"rag","intent":"resolve_doc","task_plan":["resolve_doc","search_section"],"needs_memory":false,"is_legal_query":true,"reasoning":"Named decree + article number"}}

"Tóm tắt điều 3 Luật An ninh mạng 2018"
→ {{"next_agent":"rag","intent":"resolve_doc","task_plan":["resolve_doc","search_section"],"needs_memory":false,"is_legal_query":true,"reasoning":"Named law + article → resolve then read section"}}

"So sánh điều 5 và điều 7 Nghị định 60"
→ {{"next_agent":"rag","intent":"resolve_doc","task_plan":["resolve_doc","search_section"],"needs_memory":false,"is_legal_query":true,"reasoning":"Named decree + multiple articles → resolve first, search_section covers multi-article"}}

"Khoản 2 Điều 8 Thông tư 15/2026/TT-BCA quy định gì?"
→ {{"next_agent":"rag","intent":"resolve_doc","task_plan":["resolve_doc","search_section"],"needs_memory":false,"is_legal_query":true,"reasoning":"Full doc number + specific clause"}}

──── SEARCH_SECTION without resolve (UUID already in state) ────

"Điều 5 nói gì?" [document already selected by user]
→ {{"next_agent":"rag","intent":"search_section","task_plan":["search_section"],"needs_memory":false,"is_legal_query":true,"reasoning":"Article reference without naming doc — UUID already in state, skip resolve"}}

"Chương II quy định về điều gì?"
→ {{"next_agent":"rag","intent":"search_section","task_plan":["search_section"],"needs_memory":false,"is_legal_query":true,"reasoning":"Chapter reference, no new doc named, use existing UUID"}}

──── RESOLVE_DOC + SUMMARIZE (summarize a named document) ────

"Tóm tắt Luật An ninh mạng 2018"
→ {{"next_agent":"rag","intent":"resolve_doc","task_plan":["resolve_doc","summarize"],"needs_memory":false,"is_legal_query":true,"reasoning":"Named law to be summarized → must find doc UUID first"}}

"Tóm tắt Nghị định 13/2023/NĐ-CP về bảo vệ dữ liệu cá nhân"
→ {{"next_agent":"rag","intent":"resolve_doc","task_plan":["resolve_doc","summarize"],"needs_memory":false,"is_legal_query":true,"reasoning":"Named decree with explicit number → resolve then summarize"}}

──── WRITE (user provides text inline) ────

"Tóm tắt đoạn văn sau: Chương trình mục tiêu quốc gia..."
→ {{"next_agent":"write","intent":"write_summarize","task_plan":["write_summarize"],"needs_memory":false,"is_legal_query":false,"reasoning":"Inline text provided after 'tóm tắt' — not a law reference"}}

"Kiểm tra ngữ pháp đoạn này: [text]"
→ {{"next_agent":"write","intent":"write_grammar_check","task_plan":["write_grammar_check"],"needs_memory":false,"is_legal_query":false,"reasoning":"Grammar check on user-provided text"}}

"Góp ý chỉnh sửa bản thảo sau: [draft]"
→ {{"next_agent":"write","intent":"write_suggest_edits","task_plan":["write_suggest_edits"],"needs_memory":false,"is_legal_query":false,"reasoning":"Editing suggestions for provided draft"}}

──── PEOPLE (person record lookup) ────

"Tìm người dùng CCCD 012345678901"
→ {{"next_agent":"people","intent":"mongo_search_cccd","task_plan":["mongo_search_cccd"],"needs_memory":false,"is_legal_query":false,"reasoning":"Person lookup by ID number"}}

"Tìm Nguyễn Văn A trong hệ thống"
→ {{"next_agent":"people","intent":"mongo_search_name","task_plan":["mongo_search_name"],"needs_memory":false,"is_legal_query":false,"reasoning":"Person search by name"}}

"Tra cứu số BHXH 1234567890"
→ {{"next_agent":"people","intent":"mongo_search_bhxh","task_plan":["mongo_search_bhxh"],"needs_memory":false,"is_legal_query":false,"reasoning":"Social insurance number lookup"}}

"Số điện thoại 0901234567 của ai?"
→ {{"next_agent":"people","intent":"mongo_search_phone","task_plan":["mongo_search_phone"],"needs_memory":false,"is_legal_query":false,"reasoning":"Person lookup by phone"}}
