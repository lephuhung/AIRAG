...
_DEFAULT_DOC_TYPES: list[_DocType] = [
    _DocType("nghi_quyet", "Nghị quyết", "Nghị quyết cá biệt của cơ quan nhà nước"),
    _DocType("luat", "Luật", "Luật do Quốc hội ban hành"),
    _DocType("phap_lenh", "Pháp lệnh", "Pháp lệnh do Ủy ban Thường vụ Quốc hội ban hành"),
    ...
    _DocType("chi_thi",    "Chỉ thị",   "Chỉ thị của Thủ tướng, Bộ trưởng, cơ quan nhà nước"),
    _DocType("quy_che",    "Quy chế",   "Quy chế quy định trách nhiệm, quyền hạn tổ chức"),
    _DocType("quy_dinh",   "Quy định",  "Quy định về thể thức, thủ tục hành chính"),
    _DocType("thong_bao",  "Thông báo", "Thông báo hành chính"),
    _DocType("huong_dan",  "Hướng dẫn", "Hướng dẫn thực hiện, nghiệp vụ"),
    _DocType("chuong_trinh",      "Chương trình",   "Chương trình hành động, chương trình quy hoạch"),
    _DocType("ke_hoach",          "Kế hoạch",       "Kế hoạch công tác, kế hoạch triển khai"),
    _DocType("phuong_an",         "Phương án",      "Phương án đề xuất, phương án xử lý"),
    _DocType("de_an",             "Đề án",          "Đề án đầu tư, đề án triển khai"),
    _DocType("du_an",             "Dự án",          "Dự án đầu tư xây dựng, dự án nghiên cứu"),
    _DocType("bao_cao",           "Báo cáo",        "Báo cáo định kỳ, chuyên đề, báo cáo tài chính"),
    _DocType("bien_ban",          "Biên bản",       "Biên bản họp, biên bản làm việc, biên bản kiểm tra"),
    _DocType("to_trinh",          "Tờ trình",        "Tờ trình trình lên cấp trên"),
    _DocType("hop_dong",          "Hợp đồng",       "Hợp đồng kinh tế, dân sự, lao động"),
    _DocType("cong_van",          "Công văn",       "Công văn hành chính"),
    _DocType("cong_dien",         "Công điện",      "Công điện khẩn của cơ quan nhà nước"),
    _DocType("ban_ghi_nho",       "Bản ghi nhớ",    "Bản ghi nhớ (MOU) giữa các bên"),
    _DocType("ban_thoa_thuan",    "Bản thỏa thuận", "Bản thỏa thuận hợp tác, thoả thuận song phương"),
    _DocType("giay_uy_quyen",     "Giấy ủy quyền",  "Giấy ủy quyền đại diện"),
    _DocType("giay_moi",          "Giấy mời",       "Giấy mời tham dự họp, hội nghị"),
    _DocType("giay_gioi_thieu",   "Giấy giới thiệu","Giấy giới thiệu nhân sự, giấy công tác"),
    _DocType("giay_nghi_phep",    "Giấy nghỉ phép", "Giấy xin nghỉ phép, đơn nghỉ phép"),
    _DocType("phieu_gui",         "Phiếu gửi",      "Phiếu gửi tài liệu, văn bản"),
    _DocType("phieu_chuyen",      "Phiếu chuyển",   "Phiếu chuyển tài liệu, phiếu chuyển công tác"),
    _DocType("phieu_bao",         "Phiếu báo",      "Phiếu báo cáo, phiếu thông báo nội bộ"),
    _DocType("thu_cong",          "Thư công",       "Thư công gửi đối tác, thư công văn thư"),
]
