...
This project is indexed by GitNexus as **AIRAG** (6856 symbols, 15419 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
